...
#                                      BasicConv1d(256, 256, 3, padding = 1, norm_layer = norm_layer),
        ...
        self.postlstm = nn.Sequential(BasicConv1d(256, 128, 3, stride = 2, padding = 1, norm_layer = norm_layer),
                                      ## 128 * 128
                                     BasicConv1d(128, 64, 3, stride = 2, padding = 1, norm_layer = norm_layer),
                                      ## 64 * 64
